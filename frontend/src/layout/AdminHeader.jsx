        ...
        <div className='root-container'>
            <div className='admin-navbar-container'>
                <div className='admin-logo-section'>
                    ...
                    <span>Namaste Admin!</span>
                </div>
                <div className='navbar-items'>
                    <Link to="/" className={getNavItem('/')} style={{ textDecoration: "none", color: "inherit" }}><span>Home</span></Link>
                    <Link to="/doctors" className={getNavItem('/doctors')} style={{ textDecoration: "none", color: "inherit" }}><span>Add Speciality</span></Link>
                    <Link to="/doctors" className={getNavItem('/doctors')} style={{ textDecoration: "none", color: "inherit" }}><span>Add Doctor</span></Link>
                    {/* <span>Doctor</span> */}
                    <Link to="/appointment" className={getNavItem('/appointment')} style={{ textDecoration: "none", color: "inherit" }}><span>Appointment Control</span></Link>
